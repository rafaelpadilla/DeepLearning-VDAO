...
# def test_RF_classifier(rf_classifier, )
...
for fold in folds:
    ...
    for layer in layers:
        ...
        for table in test_object_info:
            ...
            X_test, Y_test_hat, paths_feat_testing = get_features(dir_features_test, max_features_per_class=None, shuffle=True, balance_classes=False)
            # Get amount of positives and negatives
